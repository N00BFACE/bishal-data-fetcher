...
namespace Bishal\DataFetcher\CLI;

/**
 * WP-CLI command class for Bishal Data Fetcher.
 */
class CLI extends \WP_CLI_Command {
	...
	public static function register() {
		\WP_CLI::add_command( 'bdf', self::class );
	}
	...
	public function fetch( $args, $assoc_args ) {
		...
		if ( ! $force ) {
			...
			if ( false !== $cached_data ) {
				...
				\WP_CLI::line( __( 'Data: ', 'bishal-data-fetcher' ) . wp_json_encode( $cached_data, JSON_PRETTY_PRINT ) );
				return;
			}
		} else {
